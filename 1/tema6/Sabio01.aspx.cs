    ...
    public partial class Sabio01 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                using (Conexao)
                {
                    string queryString = "SELECT MAX(Codigo) AS max_Codigo FROM Perg0006";
                    ...
                    try
                    {
                        ...
                        queryString = "SELECT USD_Consec, USD_Sala6 FROM UserDados WHERE USR_ID = " + Session["id"];
                        ...
                        DadosS.Read();
                            ...
                            text = DadosS["USD_Sala6"].ToString();
                        DadosS.Close();
                        ...
                        if (text != "new")   //dPerg:1Sala:0Data:10/04/2021Qtde:1
                        {
                            ...
                            queryString = "SELECT * FROM Perg0006 WHERE Codigo = " + (Convert.ToInt16(pPerg) + 1);
                        ...
                        {
                            pSala = 0;
                            queryString = "SELECT * FROM Perg0006 WHERE Codigo = 1";
                        ...
                        queryString = "UPDATE UserDados SET USD_Sala6 = '" + text + "', USD_Acesso = '" + Hoje + "' WHERE USR_ID = " + Session["id"];
        ...
        protected void LeSala(OdbcConnection Conexao)
        {
            using (Conexao)
            {
                string queryString = "SELECT USD_Total, USD_Consec, USD_Sala6 FROM UserDados WHERE USR_ID = " + Session["id"];
                OdbcCommand command = new OdbcCommand(queryString, Conexao);
                ...
                try
                {
                    ...
                    UsuarioDados.Read();
                        text = UsuarioDados["USD_Sala6"].ToString();
        ...
        protected void NewResposta(int IDPerg, OdbcConnection Conexao)
        {
            using (Conexao)
            {
                string queryString = "SELECT Resposta FROM Perg0006 WHERE Codigo = " + IDPerg;
                OdbcCommand command = new OdbcCommand(queryString, Conexao);
        ...
        protected void NewPergunta(int IDPerg, OdbcConnection Conexao)
        {
            using (Conexao)
            {
                string queryString = "SELECT * FROM Perg0006 WHERE Codigo = " + IDPerg;
                OdbcCommand command = new OdbcCommand(queryString, Conexao);
        ...
        protected void GravaSala(OdbcConnection Conexao)
        {
            using (Conexao)
            {
                string queryString = "UPDATE UserDados SET USD_Total = " + pTotl + ", USD_Consec = " + pCosc + ",  USD_Sala6 = '" + text + "', USD_Acesso = '" + Hoje + "' WHERE USR_ID = " + Session["id"];
                OdbcCommand command = new OdbcCommand(queryString, Conexao);
            ...
            using (Conexao)
            {
                if (HFPCert.Value == "0")
                {
                    ...
                    try
                    {
                        ...
                        queryString = "SELECT Resposta FROM Perg0006 WHERE Codigo = " + newIDPerg;
                        ...
                        queryString = "UPDATE UserDados SET USD_Total = " + pTotl + ", USD_Consec = " + pCosc + ",  USD_Sala6 = '" + text + "', USD_Acesso = '" + Hoje + "' WHERE USR_ID = " + Session["id"];
                        command = new OdbcCommand(queryString, Conexao);
                        command.ExecuteReader();
                ...
                if (HFPCert.Value == "1")
                {
                    ...
                    try
                    {
                        ...
                        if (sQtde > Convert.ToInt16(Session["Dia"].ToString()))         /* || IDPerg > slMax */
                        {
                            ...
                            //      cu[2] = "6";                HFco2.Value = "6";  //Numero da Sala
                        ...
                        else
                        {
                            ...
                            queryString = "SELECT * FROM Perg0006 WHERE Codigo = " + IDPerg;
                            command = new OdbcCommand(queryString, Conexao);
                            OdbcDataReader Perguntas = command.ExecuteReader();
                            Perguntas.Read();
                                perg1 = Perguntas["Pergunta"].ToString();
