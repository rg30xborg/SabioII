...
Else
	...
	Function NewPergunta(IDPerg, Conexao)
		...
		Perguntas.Open "SELECT * FROM Perg0004 WHERE Codigo=" & IDPerg, Conexao
	...
	Function LeSala(Conexao)
		...
		UsuarioDados.Open "SELECT USD_Total, USD_Consec, USD_Sala4 FROM UserDados WHERE USR_ID = " & Session("id"), Conexao
			text0 = UsuarioDados("USD_Sala4")
	...
	Function GravaSala(Conexao)
		Conexao.Execute "UPDATE UserDados SET USD_Total = " & pTotl & ", USD_Consec = " & pCosc & ",  USD_Sala4 = '" & text1 & "' WHERE USR_ID = " & Session("id")
	End Function
End If
%>
...
function Method1(apost,final){
	...
	if(IDResp == apost && final < 26){
		...
		text1 = IDResp + "Perg:" + IDPerg + "Sala:" + pSala + "Data:" + Session("Hoje") + "Qtde:" + sQtde
	}
...
function Method2(){
	...
	else{ resp0 = perg1 = resp1 = resp2 = resp3 = resp4 = resp5 = ""

		if(IDPerg > Session("Dados")) IDPerg = 1
		NewPergunta(IDPerg, Conexao)

		text1 = resp0 + "Perg:" + IDPerg + "Sala:" + pSala + "Data:" + Session("Hoje") + "Qtde:" + sQtde
