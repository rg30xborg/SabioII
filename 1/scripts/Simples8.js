...
function noImage(num) {
    if (cart == 1) {
        for (var i = 1; i < 4; i++) document.images["n" + i].src = "../images/happy0.gif"
        document.images["n" + num].src = "../images/happy3.gif"
    }
	switch(num){
		case 1 : apost = "m"; break
		case 2 : apost = "l"; break
		case 3 : apost = "d"; break
    }
    document.getElementById("HFApost").value = apost;
}
...
function myFirstBack1(obj, co) {
    ...
    if (cox == "xo") location.href = "Sabio03.aspx?ptSala=" + co[1];       //"http://www.aggora.com.br/sabio/1/tema" + co.return_value[2] + "/"
        ...
        audio.style.visibility = 'hidden'; Aaudio.src = "";
        video.style.visibility = 'hidden'; Avideo.src = "";
        image.style.visibility = 'hidden'; Aimage.src = "";
        tela.style.height = "auto"; 
        if (co[3] == "Audio") {
            tela.style.height = "50px"; audio.style.visibility = "visible"; Aaudio.src = co[4];
        }
        else if (co[3] == "Video") {
            tela.style.height = "250px"; video.style.visibility = "visible"; Avideo.src = co[4];
            }
            else if (co[3] == "Imagem") {
                tela.style.height = "250px"; image.style.visibility = "visible"; Aimage.src = co[4];
                }
