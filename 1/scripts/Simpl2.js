...
function Aviso2(){
	...
	//else{	// window.defaultStatus = 'RG 3.0 - Sabichão Web [POKER 1]'
        NCalc.innerText = " ";
        Reg16.innerText = "Defina o valor da Aposta Padrão";
...
function filaOk1(){
    if (fila1x == 4) {
        fila1x = 0; image1.style.visibility = "hidden"; image1.title = "NÃO Descartar carta"
    ...
    if (fila1x == 1) {
		...
		Reg16.innerText = 'Três clicks na 1º Carta = Filar'; image1.title = "1º Carta da Dobra"
...
function filaOk2(){
    if (fila2x == 4) {
        fila2x = 0; image2.style.visibility = "hidden"; image2.title = "NÃO Descartar carta"
    ...
    if (fila2x == 1) {
		...
		Reg16.innerText = 'Três clicks na 2º Carta = Filar'; image2.title = "2º Carta da Dobra"
        Reg17.innerText = 'Palpite = ' + (dob == 'x1' ? (numero + naipe) : (dob == '>' ? 'Maior que 7' : 'Menor que 7'))
	}
}
...
function filaOk3(){
    if (fila3x == 4) {
        fila3x = 0; image3.style.visibility = "hidden"; image3.title = "NÃO Descartar carta"
    ...
    if (fila3x == 1) {
		...
		Reg16.innerText = 'Três clicks na 3º Carta = Filar'; image3.title = "3º Carta da Dobra"
        Reg17.innerText = 'Palpite = ' + (dob == 'x1' ? (numero + naipe) : (dob == '>' ? 'Maior que 7' : 'Menor que 7'))
	}
}
...
function filaOk4(){
    if (fila4x == 4) {
        fila4x = 0; image4.style.visibility = "hidden"; image4.title = "NÃO Descartar carta"
    ...
    if (fila4x == 1) {
		...
		Reg16.innerText = 'Três clicks na 4º Carta = Filar'; image4.title = "4º Carta da Dobra"
        Reg17.innerText = 'Palpite = ' + (dob == 'x1' ? (numero + naipe) : (dob == '>' ? 'Maior que 7' : 'Menor que 7'))
	}
}
...
function filaOk5(){
    if (fila5x == 4) {
        fila5x = 0; image5.style.visibility = "hidden"; image5.title = "NÃO Descartar carta"
		image5.src = '/_Library/carta.gif'; Reg17.innerText = r
        cart = 0;
        Reg21.src = '/_Library/botcr.gif';
        if (lok_it == 'yes') {
            Broncyes(); alert('Ok!!!!, Você tentou, ...')
        }
        else {
    ...
    if (fila5x == 1) {
		...
		Reg16.innerText = 'Três clicks na 5º Carta = Filar'; image5.title = "5º Carta da Dobra"
        Reg17.innerText = 'Palpite = ' + (dob == 'x1' ? (numero + naipe) : (dob == '>' ? 'Maior que 7' : 'Menor que 7'))
	}
}
