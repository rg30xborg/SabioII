...
function myFirstBack1(obj, co) {
    ...
    cox = co[0];
    if (cox == "xo") location.href = "Sabio03.aspx?ptSala=" + co[1] + "&nEmpr=Anuncie_Aqui!!!";       //"http://www.aggora.com.br/sabio/1/tema" + co.return_value[2] + "/"
    else {
        ...
        nEmpr.innerHTML = "<a href='Sabio04.aspx?ref=" + co[7]
            + "' target='_parent'><img src='../../banner/" + co[8]
            + "' width=97 height=56 border=0 alt='Home Page da " + co[6] + "'></a>";
        for (var i = 1; i < 6; i++) {
