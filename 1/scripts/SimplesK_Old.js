...
function Envia1(){
 	nome = anuncie.Contato.value
	empresa = anuncie.Empr.value
 	mail = anuncie.E_mail.value
	fone = anuncie.Fone.value
	if(anuncie.Cntt(0).checked && fone == ''){
