...
function OnCarg(){
    ...
    if (Revisar.perg.value == "") Revisar.perg.focus()
}
...
function Verfica1(){
    ...
    Revisar.action = "Sabio04.aspx"; Revisar.submit();         //http://www.aggora.com.br/sabio/1/promo/
}
...
function VerficaARQ(){
    ...
    Revisar.action = "Sabio07.aspx"; Revisar.submit();        //http://www.aggora.com.br/sabio/1/promo/
}
