...
%><Script Language="JScript.Encode" src="../images/Simples7.js"></Script>
<html><head><title>Sabichao</title><style>@import url(../images/coUC.css);</style>
</head><body bgcolor="#FFFFFF" onLoad="Aviso2('document.somregis',1)">
			...
			<table width="100%" cellspacing="0" cellpadding="10">
				<tr>
					...
					<td width="10%" align="center" valign="middle"><img src="../images/happy3.gif"
						...
						style="border:0;background-color:#FDB4B1;background-image:url('../images/bt3.gif');width:115;height:25"></td>
				</tr>
			</table>
		</td>
