...
<BODY bgColor="#FFFFFF" background="../mundi.gif" leftMargin="0" topMargin="3" marginwidth="0" marginheight="0">
...
<p>
			...
			Para re-personalizar, reintroduza <b><font color="blue">Seu E-mail e Senha</font></b>, e sua seção será reinicializada. Grato.</p>
				...
				<tr>
					<td>
                        <form id="logonForm" runat="server" method="GET" onsubmit="return verifica()" target="_parent">
                            <br />
