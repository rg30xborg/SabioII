<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sabio01.aspx.cs" Inherits="Sabio._1.empre.Sabio01" %>
...
<p style="font-size: 10pt">
	Assunto da Sala: <b><font color="#0588C0">SUA EMPRESA</font><span ID="NCalc"> - Carregando .... </span></b>
...
<p align="justify"><span style="font-family: Verdana; font-size:11pt"> <b>Sua Empresa no Sabichão</b>
            ...
            <form id="Sala" runat="server">
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" EnableViewState="False">
                    <contenttemplate>
                        ...
                        <p><span ID="nEmpr"><a href="Sabio04.aspx?ref=<%=lEmpr%>" target="_parent"><img src='../../banner/<%=iEmpr%>' width="97" height="56" border="0" title="Home Page da <%=eEmpr%>" /></a></span><small><br />(Ver *Dica)</small></p>
                        ...
                        <script type="text/javascript" src="../scripts/SimplesE.js"></script>
