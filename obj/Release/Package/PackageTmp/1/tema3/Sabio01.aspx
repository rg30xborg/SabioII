<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sabio01.aspx.cs" Inherits="Sabio._1.tema3.Sabio01" %>
...
<p style="font-size: 10pt">
	Assunto da Sala: <b><font color="#0588C0">MISCELANIA II</font><span ID="NCalc"> - Carregando .... 
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
	<tr valign="TOP"> 
		...
		<td bgcolor="#F94942" width="64%"><br />
			<b><span style="font-size: 9pt; color: #FFFFFF" ID="NPerg">A Incógnita = As perguntas desta Sala devem ser
			respondidas descritivamente em até 5 palpites. Assim prepare-se..., quando estiver pronto para iniciar,
			clique na seta CONTINUAR.</span></b>
		</td>
		...
		<td width="24%" align="CENTER" valign="TOP">
			...
			<br><font style="font-size: 12pt"><span ID="NValr1">50</span> pontos</b></font></td>
	</tr>
	<tr valign="TOP"> 
		<td width="8%"></td>
	...
	<tr valign="TOP"> 
		...
		<td bgcolor="#FDB4B1" width="64%">
			<table width="100%" cellspacing="0" cellpadding="2">
				<tr>
					<td align="center" width="100"><img src="images/sabio00.gif" id="NFig1" width="100" height="180"></td>
					<td><div ID="NTabl" style="visibility:hidden">
						<table width="100%" height="100%" cellspacing="0" cellpadding="2">
							<tr height="70%" align="center" valign="middle">
								<td><img src="images/sabio06.gif" id="NFig2" width="180" height="100" /></td>
							</tr>
							<tr height="30%" align="center" valign="middle">
								<td>Resposta:<br /><input type="text" id="Resposta" maxlength="50" style="width:180px" /></td>
							</tr>
						</table>
					</div></td>
					<td width="100" valign="top"><span ID="NValr2">Palpites:</span></td>
				</tr>
			</table>
		</td>
            ...
            <form id="Sala" runat="server">
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" EnableViewState="False">
                    <contenttemplate>
                        ...
                        <script type="text/javascript" src="../scripts/Simples5.js"></script>
