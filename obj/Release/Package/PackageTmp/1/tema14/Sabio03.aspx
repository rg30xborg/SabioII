<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sabio03.aspx.cs" Inherits="Sabio._1.tema14.Sabio03" %>
...
</head><body bgcolor="#FFFFFF" onLoad="Aviso2('somregis',14)">
<p style="font-size: 10pt">
	Assunto da Sala: <font color="#0588C0"><b>SEU TALENTO</b></font>
			...
			<table width="100%" cellspacing="0" cellpadding="10">
                <tr>
					<td width="90%" valign="middle"><p align="justify">
						<font style="font-size: 12pt"><b>Envie Suas Criações Artisticas</b>:</font>
						<br><br>Como você sabe, esta Sala possui "Obras de Arte" exclusivas criadas por usuários do Sabichão, 
<%
    //Verifica se User já encaminhou perguntas.
    if (qPerg == 0)
    {
        btTex = "Adicione<br>sua Arte";
%>
						e você ainda não enviou <b>nenhuma</b>. Aproveite agora, adicione quantas desejar e fature pontos Extras... 
<%
    }
    else
    {
        btTex = "Adiministre<br>suas Artes";
%>
...
<%  } %>
					...
					<td width="10%" align="center" valign="middle"><img name="botao"
						onClick="location.href='../promo/Sabio06.aspx'" alt="Promoções - Talentos de Usuários"
...
<p>Sala [Seu Talento] Concluida! - Maneiro, fique frio que amanha tem mais <%=Session["Dia"]%> :)</p>
