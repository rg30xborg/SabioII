...
<center>
<form method="GET" id="formDelete" name="formDelete" action="Sabio13.aspx" onsubmit="return limpaMens()">
...
<table width="90%" cellspacing="2" cellpadding="1">
	<tr bgcolor='#FFFFDF' align="center">
		<td width='5%'><input type='checkbox' id='<%=nBox%>' name='<%=nBox%>' value='<%=Eventos["EVN_Cod"]%>' /></td> 
...
<table width="90%">
	<tr>
		<td>
			<br><input type="submit" value="Remover Mens." id="ApagaData" name="ApagaData" style="cursor:pointer;border:0;background-color:rgb(255,255,255);background-image:url('images/bt3.gif');width:115px;height:25px">
		</td>
	</tr>
</table>
<%
...
<%
            ...
            {
                pTotl = Convert.ToInt32(DadosUsuario["USD_Total"]);
                int pGerl = pTotl + Convert.ToInt32(DadosUsuario["USD_Apts"]);
...
<p><input type="button" onClick="location.href='Sabio22.aspx'" value="Resumo Salas" style="cursor:pointer;border:0;background-color:rgb(255,255,255);background-image:url('images/bt3b.gif');width:115px;height:25px">
<%
                DadosUsuario.Close();
            }
            //Tirei Daki
