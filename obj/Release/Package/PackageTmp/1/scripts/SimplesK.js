...
function Envia1(j){
    ...
    if (obs == '') {
        alert("RG 3.0 - DADOS INCOMPLETOS:\n\nO Campo Comentários Adicionais parece estar vazio\nFineza tecer alguma observação para analises na opção [6|7]\n\n... Acrescente-o e após isto tente novamente.      Grato.")
        return false
    }
    if (nome != '' && mail != '' && (mail.indexOf("@") > 0) && empresa != '' && obs != ''){
