...
function Aviso2(){
	if((this.location.href).indexOf("http://www.aggora.com.br") < 0) location.href = "http://www.aggora.com.br/sabio/help.htm"
		...
		NCalc.innerText = " "; Reg16.innerText = "Para iniciar adquira o Prognóstico do Páreo (click na ficha acima)"
	}
}
...
function addProspR(co){
	if(co.return_value[0] == "ok"){
		...
		Reg16.innerText = 'Pontos Total inferior ao mínimo da Sala !!'; Reg22.src = '/_Library/botjkb.gif'
...
function myBackCart(co){
	if(co.return_value[0] == 'ok'){
		...
		Reg00.style.visibility = "hidden"; Reg17.innerText = "Páreo em disputa, aguarde ..."; alocar1('play','somrolar')
...
function instrui(){
	...
	+ "     Clique simples na ficha do centro libera o Páreo\n"
