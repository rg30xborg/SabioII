<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="Sabio01.aspx.cs" Inherits="Sabio._1.tema15.Sabio01" %>
...
<p style="font-size: 10pt">
	Assunto da Sala: <b><font color="#0588C0">ENVIADAS POR USUÁRIOS</font><Span ID="NCalc"> - Carregando .... </Span></b>
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
	<tr valign="TOP"> 
		...
		<td bgcolor="#F94942" width="64%"> - AQUI VOCÊ GANHA PONTOS RESPONDENDO PERGUNTAS DE USUÁRIOS DO SITE<br />
            ...
            <form id="Sala" runat="server">
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" EnableViewState="False">
                    <contenttemplate>     
                        ...
                        <p><input type="button" value="Enviar Perguntas" style="border:0;background-color:rgb(255,255,255);background-image:url('../images/bt3c.gif');width:115px;height:25px" onClick="location.href='../promo/Sabio03.aspx'"></p>
