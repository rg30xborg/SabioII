<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sabio03.aspx.cs" Inherits="Sabio._1.tema15.Sabio03" %>
...
</head><body bgcolor="#FFFFFF" onLoad="Aviso2('somregis',15)">
<p style="font-size: 10pt">
	Assunto da Sala: <font color="#0588C0"><b>ENVIADAS POR USUÁRIOS</b></font>
	...
	<tr valign="TOP"> 
		...
		<td bgcolor="#FDB4B1" width="64%">
			<table width="100%" cellspacing="0" cellpadding="10">
                <tr>
					<td width="90%" valign="middle"><p align="justify">
						<font style="font-size: 12pt"><b>Adicione Suas Perguntas</b>:</font>
						<br><br>Como você sabe, esta Sala possui perguntas exclusivas de usuários do Sabichão, 
<%
    //Verifica se User já encaminhou perguntas.
    if (qPerg == 0)
    {
        btTex = "Adicione<br>suas Perguntas";
%>
						e você ainda não enviou <b>nenhuma delas</b>. Aproveite agora, adicione quantas
						desejar e fature pontos Extras... 
<%
    }
    else
    {
        btTex = "Adiministre<br>suas Perguntas";
%>
						até porque <b><%=qPerg%> delas</b> foi você que enviou. Continue assim, adicione
						quantas desejar e fature pontos Extras... 
<%  } %>
						Se tiver alguma sujestão ou critica sobre esta Sala, é so entrar em
						<a href="mailto:rg30@bol.com.br?subject=Gerais de Usuários">Contato</a>.</p></td>
					<td width="10%" align="center" valign="middle"><img name="botao"
						onClick="location.href='../promo/Sabio03.aspx'" alt="Promoções - Perguntas de Usuários"
						width="97" height="56" src="../images/cont001.gif"
						onMouseOver="onBotao()" onMouseOut="ofBotao()"><br><%=btTex%></td>
				</tr>
				<tr>
					...
					<td width="10%" align="center" valign="middle"><img src="../images/happy3.gif"
						...
						style="border:0;background-color:#FDB4B1;background-image:url('../images/bt3.gif');width:115px;height:25px"></td>
				</tr>
			</table>
		</td>
...
<p>Sala [De Usuários] Concluida! - Legal, esta tá aniquilada, aqui novamente só amanha :)</p>
