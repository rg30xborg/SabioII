<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sabio19.aspx.cs" Inherits="Sabio._1.Sabio19" %>
...
<p align="left" style="font-size: 10pt">
	Exemplo de: <font color="#0588C0"><b>JOGOS ONLINE</b></font>
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
	<tr valign="TOP"> 
		...
		<td bgcolor="#4444FF" width="86%" style="font-size:10pt;color:#FFFFFF">
			<b><p align="justify">Após os estudos um momento para o Lazer.
			<br>- Perg.: Quem pode desfrutar desta área?  
			<br>- Resp.: Todos que acumularam pontos nas Salas de Perguntas.<br>
			<br>Aqui voce arrisca quantos pontos desejar em diversas opções de Jogos, e pode com isto, aumentar ainda
