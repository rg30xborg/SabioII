<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="Sabio01.aspx.cs" Inherits="Sabio._1.tema1.Sabio01" %>
            ...
            <form id="Sala" runat="server">
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" EnableViewState="False">
                    <contenttemplate>     
                        ...
                        <script type="text/javascript" src="../scripts/Simples2.js"></script>
