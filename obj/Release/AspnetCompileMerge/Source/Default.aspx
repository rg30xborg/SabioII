...
<p><a href="1/sabichao2.html" target="_top" onclick="window.open(this.href,'','fullscreen');return false;">Clique Aqui para ENTRAR no <b>Site Sabichão (º_º)</b></a></p>
<p>&nbsp;</p>
    <%--<div style="width:70%" width="70%"><p align="justify">O QUE É O SABICHÃO?</b> É um Site-Jogo tipo QUIZ com 
        assuntos variados em um ambiente interativo, com muita informação e humor. É <b>Totalmente Gratúito</b> e 
        você corre o risco de ganhar » varios PRÊMIOS!</p></div>--%>
    <p>&nbsp;</p>
	...
	<TBODY>
		<TR height="100px">
			...
			<TD background="1/images/f01a.gif" style="background-repeat:no-repeat">&nbsp;</TD>
			<TD align="left" valign="top" background="1/images/f01a.gif" width="135" style="background-repeat:no-repeat"><a href="1/sabichao2.html" target="_top" onclick="window.open(this.href,'','fullscreen');return false;"><IMG height=100 src="1/images/logo3a.gif" title="Clique para Entrar!" width=120 border=0 alt="Alternar Visual do Site"></a></TD>
		</TR>
        <tr>
...
<p>Qualquer sujestão contate-nos em <a href="mailto:contato@aggora.com.br?subject=Contato Página Inicial Sabichão">contato@aggora.com.br</a></p>
<p><div align="right">
